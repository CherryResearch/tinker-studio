...
- Public or semi-public code/docs/dashboard/skills: publish through the main Tinker repo under Public Maintainer when appropriate.
...
- `public-remote`: ML-related, semi-professional public-facing blog, pseudo-startup, and computer-led research work.
...
Default to ignored local storage for raw training data. Move polished public research/code or reviewed private tooling to Public Maintainer only after explicit user direction.
