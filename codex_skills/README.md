...
```text
C:\Users\kaist\.codex\skills\tinker-codex-skills
```

Keep real keys in ignored `.env` or local secret stores only. `.env.example` should contain placeholders and relative paths such as `data/training_data_cerise`.
