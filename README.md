...
Private dataset storage lives outside the public Tinker tree under `data/`. By default the tools look for `data/training_data_cerise`, or a path from `TINKER_STUDIO_DATASET_ROOT` / `TINKER_DATASET_ROOT`.
